    ...
    <form action="" method="post" name="frm">  
        ...
        <table id="corpo-cad">
            ...
            <tr><td colspan="2"><h2 style="color:#fff;margin-left:80px">ENTRAR</h2></td></tr>
                ...
                <?php
                if($cpf!=""){
                echo "<tr><td><label >esse cpf já votou!!</label></td></tr>"; 
                } 
                ...
                <tr><td colspan="2"><input type="text" id="sen" name="sen" class="inp-log"></td></tr>
                <?php 
                if(isset($_GET["ext"])){
                    echo "<tr><td><label >CPF OU CODIGO ERRADO!!</label></td></tr>"; 
                    } 
                ?>
